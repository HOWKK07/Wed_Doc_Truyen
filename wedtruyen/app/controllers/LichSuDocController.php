...
function tangLuotXemChuong($conn, $id_nguoidung, $id_chuong) {
    // Luôn tăng lượt xem chương mỗi lần vào
    $sql_update = "UPDATE chuong SET luot_xem = luot_xem + 1 WHERE id_chuong = ?";
    $stmt_update = $conn->prepare($sql_update);
    $stmt_update->bind_param("i", $id_chuong);
    $stmt_update->execute();
}
?>